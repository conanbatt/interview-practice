...
const _requestasyncstorage = require("../../client/components/request-async-storage");
...
async function adapter(params) {
   ...
   */ if (isDataReq) {
    ...
    if (params.page === "/middleware") {
        response = await _requestasyncstoragewrapper.RequestAsyncStorageWrapper.wrap(_requestasyncstorage.requestAsyncStorage, {
            req: request,
            renderOpts: {
