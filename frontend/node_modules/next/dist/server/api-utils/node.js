    ...
    try {
        if (context.trustHostHeader) {
            ...
            if (ipcPort) {
                ...
                const res = await (0, _invokerequest.invokeRequest)(`http://${context.hostname || "localhost"}:${ipcPort}?key=${ipcKey}&method=revalidate&args=${encodeURIComponent(JSON.stringify([
                    {
                        urlPath,
                        revalidateHeaders,
                        opts
