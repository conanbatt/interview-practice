...
describe('ThreeStacks', () => {
    ...
    test('push elements beyond stack capacity', () => {
        ...
        // Attempt to push elements beyond stack capacity should throw errors
        expect(() => threeStacks.push(0, 4)).toThrow();
        expect(() => threeStacks.push(1, 5)).toThrow();
        expect(() => threeStacks.push(2, 6)).toThrow();
    });
